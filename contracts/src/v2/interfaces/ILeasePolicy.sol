...
/// @dev The beta implements only a fixed-price/fixed-term policy. Rule-based routing
/// (length, charset, allow-list -> price tiers/auction/reserved) is grant-scope, not beta —
