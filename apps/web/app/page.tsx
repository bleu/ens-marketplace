...
const SOURCES = [
  {
    chain: "Anvil (local)",
    label: "Local",
    description: "The full marketplace: list, buy, relist, cancel, and lease subnames.",
  },
  {
    chain: "Sepolia",
    label: "ENSv2",
    description: "Register names on the ENSv2 alpha, paid in a test token.",
  },
  {
    chain: "Mainnet",
    label: "ENSv1 · Grails · OpenSea",
    description: "Browse and buy live ENS names, with listings aggregated across marketplaces.",
  },
] as const;
  ...
  return (
    <main className="mx-auto flex min-h-[calc(100vh-76px)] max-w-[720px] flex-col items-center justify-center px-4 text-center">
      ...
      <p className="mb-10 max-w-md font-mono text-sm leading-relaxed" style={{ color: "var(--fg-muted)" }}>
        What you can do depends on the network your wallet is on.
      </p>
