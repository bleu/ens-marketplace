    ...
    <div className="mx-auto max-w-[560px] px-4 py-16 text-center">
      ...
      >
        ...
        <p className="mb-7 font-mono text-[13px] leading-relaxed" style={{ color: "var(--fg-muted)" }}>
          These are our own mock ENSv2 contracts — a real deployment on a real testnet, but
          only on Sepolia. {isConnected ? "Switch networks to browse and trade them." : "Connect a wallet on Sepolia to browse and trade them."}
        </p>
        {isConnected ? (
          <button
            type="button"
